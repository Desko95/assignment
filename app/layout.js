        ...
        <div className="bg-gray-200 min-h-[100dvh] grid grid-rows-[auto_1fr_auto]">
            <header className="bg-white/50 backdrop-blur z-10">
                <div className="max-w-4xl mx-auto flex items-center justify-between">
                    <h2 className="text-2xl text-gray-500 py-6">Assignment </h2>
                    <nav>
            ...
            <main
                className="backdrop-blur z-10 max-w-4xl mx-auto bg-white/50 rounded-xl py-7 px-8 m-6 overflow-hidden">{children}</main>
            <Footer />
        </div>
        </body>
        </html>
